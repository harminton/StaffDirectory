...
namespace StaffDirectory.Controllers
{
    public class StudentsController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("StudentId,FirstName,LastName,AcNumber,Phone,ParentEmail,ParentPhone")] Students students)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("StudentId,FirstName,LastName,AcNumber,Phone,ParentEmail,ParentPhone")] Students students)
        {
